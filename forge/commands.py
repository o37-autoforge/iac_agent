...
from forge import models, prompts, voice
from forge.format_settings import format_settings
from forge.help import Help, install_help_extra
from forge.llm import litellm
from forge.repo import ANY_GIT_ERROR
from forge.run_cmd import run_cmd
from forge.scrape import Scraper, install_playwright
from forge.utils import is_image_file
...
class Commands:
    ...
    def cmd_undo(self, args):
        "Undo the last git commit if it was done by forge"
        try:
    ...
    def raw_cmd_undo(self, args):
        ...
        if last_commit_hash not in self.coder.forge_commit_hashes:
            self.io.tool_error("The last commit was not made by forge in this chat session.")
            self.io.tool_output(
    ...
    def cmd_add(self, args):
        "Add files to the chat so forge can edit them or review them in detail"
        ...
        for word in filenames:
            ...
            if self.coder.repo and self.coder.repo.ignored_file(fname):
                self.io.tool_warning(f"Skipping {fname} due to forgeignore or --subtree-only.")
                continue
    ...
    def basic_help(self):
        ...
        self.io.tool_output()
        self.io.tool_output("Use `/help <question>` to ask questions about how to use forge.")

    def cmd_help(self, args):
        "Ask questions about forge"
        ...
        user_msg += """
# Announcement lines from when this session of forge was launched:
...
"""
    ...
    def cmd_report(self, args):
        ...
        from forge.report import report_github_issue
