...
from forge.args_formatter import (
    DotEnvFormatter,
...
def get_parser(default_config_files, git_root):
    ...
    group.add_argument(
        ...
        help="Specify a file with forge model settings for unknown models",
    )
    group.add_argument(
        "--model-metadata-file",
    ...
    default_input_history_file = (
        os.path.join(git_root, ".forge.input.history") if git_root else ".forge.input.history"
    )
    default_chat_history_file = (
        os.path.join(git_root, ".forge.chat.history.md") if git_root else ".forge.chat.history.md"
    )
    group.add_argument(
        "--input-history-file",
    ...
    group.add_argument(
        ...
        default=None,
        help="Log the conversation with the LLM to this file (for example, .forge.llm.history)",
    )
    ...
    group.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=True,
        help="Enable/disable adding .forge* to .gitignore (default: True)",
    )
    default_forgeignore_file = (
        os.path.join(git_root, ".forgeignore") if git_root else ".forgeignore"
    )
    group.add_argument(
        "--forgeignore",
        metavar="forgeIGNORE",
        default=default_forgeignore_file,
        help="Specify the forge ignore file (default: .forgeignore in git root)",
    )
    group.add_argument(
        "--subtree-only",
        action="store_true",
    ...
    group.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=True,
        help="Attribute forge code changes in the git author name (default: True)",
    )
    group.add_argument(
        "--attribute-committer",
        action=argparse.BooleanOptionalAction,
        default=True,
        help="Attribute forge commits in the git committer name (default: True)",
    )
    group.add_argument(
        "--attribute-commit-message-author",
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Prefix commit messages with 'forge: ' if forge authored the changes (default: False)",
    )
    group.add_argument(
        "--attribute-commit-message-committer",
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Prefix all commit messages with 'forge: ' (default: False)",
    )
    group.add_argument(
        "--commit",
        action="store_true",
    ...
    group.add_argument(
        "--check-update",
        action=argparse.BooleanOptionalAction,
        help="Check for new forge versions on launch",
        default=True,
    )
    group.add_argument(
        "--install-main-branch",
    ...
    group.add_argument(
        ...
        "--update",
        action="store_true",
        help="Upgrade forge to the latest version from PyPI",
        default=False,
    )
    group.add_argument(
        "--apply",
    ...
    group.add_argument(
        ...
        metavar="CONFIG_FILE",
        help=(
            "Specify the config file (default: search for .forge.conf.yml in git root, cwd"
            " or home directory)"
        ),
    )
    group.add_argument(
        ...
        "--browser",
        action=argparse.BooleanOptionalAction,
        help="Run forge in your browser (default: False)",
        default=False,
    )
    group.add_argument(
