...
[forge's code editing leaderboard](https://forge.chat/docs/leaderboards/)
...
You can code with all of these models using forge like this:
...
$ forge --model deepseek/deepseek-coder

$ export MISTRAL_API_KEY=your-key-goes-here
$ forge --model mistral/mistral-large-2407

$ export OPENROUTER_API_KEY=your-key-goes-here
$ forge --model openrouter/meta-llama/llama-3.1-405b-instruct
$ forge --model openrouter/meta-llama/llama-3.1-70b-instruct
$ forge --model openrouter/meta-llama/llama-3.1-8b-instruct
```
...
secured #7 on forge's leaderboard, 
...
Mistral Large 2 (2407) scored only 60% on forge's code editing
benchmark. 
