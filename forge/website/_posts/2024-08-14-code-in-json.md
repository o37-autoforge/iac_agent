...
> Figure 1: forge coding benchmark scores of models using either plain markdown text or JSON to return code.
...
People often ask why forge uses a plain text format for LLMs to specify code edits (below),
...
Previous [forge benchmark results](/2023/07/02/benchmarks.html)
showed
...
the 
[forge "code editing" benchmark](/2023/07/02/benchmarks.html#the-benchmark)
...
forge's "whole" edit format, where the
...
#### Notes on the forge leaderboard

*The results presented here are not directly comparable to results
from the main
[forge LLM leaderboard](https://forge.chat/docs/leaderboards/).
