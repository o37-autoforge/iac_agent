...
excerpt: Sonnet's score on the forge code editing benchmark has been stable since it launched.
...
[forge code editing benchmark](/docs/benchmarks.html#the-benchmark)
via the API.
...
to evaluate the effects of small changes to forge's system prompts.
...
> The 
> [forge LLM code editing leaderboard](https://forge.chat/docs/leaderboards/)
