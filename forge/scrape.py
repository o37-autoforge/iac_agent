...
from forge import __version__, urls, utils
from forge.dump import dump  # noqa: F401

forge_user_agent = f"forge/{__version__} +{urls.website}"
...
def install_playwright(io):
    ...
    pip_cmd = utils.get_pip_install(["forge-chat[playwright]"])
...
class Scraper:
    ...
    def scrape_with_httpx(self, url):
        ...
        headers = {"User-Agent": f"Mozilla./5.0 ({forge_user_agent})"}
        try:
            with httpx.Client(
