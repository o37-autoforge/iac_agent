...
class LLMHandler:
    ...
    async def generate_intro_message(self) -> str:
        ...
        """
        prompt = """
        You are an AI assistant that greets the user who needs help with their infrastructure codebase. 
        
        Generate a singular friendly and engaging greeting message. Return the message, and nothing else.
