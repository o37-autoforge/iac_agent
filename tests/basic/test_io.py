...
from forge.io import AutoCompleter, ConfirmGroup, InputOutput
from forge.utils import ChdirTemporaryDirectory
...
class TestInputOutput(unittest.TestCase):
    ...
    def test_get_input_is_a_directory_error(self, mock_input):
        ...
        with patch("forge.io.open", side_effect=IsADirectoryError):
